...
<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab value="pnpm">```bash pnpm install graneet-form ```</Tab>
  <Tab value="npm">```bash npm install graneet-form ```</Tab>
  <Tab value="yarn">```bash yarn add graneet-form ```</Tab>
</Tabs>
...
<StackBlitzEmbed name="simple-form" height="600px" hideNavigation={false} />
...
<Callout type="info">
  **Next Steps**: Now that you understand the basics, explore our comprehensive guides on validation, field management,
  and advanced features! Don't forget to check out our [StackBlitz Integration](/stackblitz-integration) guide for more
  ways to experiment and share your forms.
</Callout>
