  ...
  render={(fieldProps, fieldState) => {
    ...
    return (
      <div className="field-container">
        ...
        {validationStatus.status === 'pending' && <span className="validation-pending">⏳ Checking...</span>}
  ...
  return (
    <div className="validation-summary">
      ...
      <div className="field-status">
        <div className={`status ${email?.status?.toLowerCase()}`}>Email: {email?.status || 'UNDETERMINED'}</div>
