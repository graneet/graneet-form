  ...
  <div className="flex">
    ...
    <div className="ml-3">
      ...
      <div className="mt-2 text-sm text-amber-700">
        <p>
          Global watching (`useFieldsWatch(form, undefined)`) causes components to re-render on every form change. Use
  ...
  <div className="flex">
    ...
    <div className="ml-3">
      ...
      <div className="mt-2 text-sm text-blue-700">
        <p>
          Always prefer specific field watching over global watching. If you need many fields, consider splitting your
          component or using multiple targeted watchers.
        </p>
      </div>
    </div>
  </div>
